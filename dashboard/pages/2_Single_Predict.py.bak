...
<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
  ...
  <div>
    <div style="font-size:1.8rem;font-weight:900;color:#0f172a;line-height:1.1">Single Customer Predict</div>
    ...
    if predict_btn:
        ...
        with st.spinner("Predicting..."):
            try:
                ...
                fig_g.update_layout(height=200, margin=dict(t=15,b=5,l=15,r=15), paper_bgcolor="white")
